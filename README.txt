...
This is the readme for tests2, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Tests) > Ok.
...
- To run the project find Tests.java (which will be in under src/main/java/tests) and right click > Run 'Tests'
